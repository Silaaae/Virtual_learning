...
import reactCourseImage from '../assets/Key-Principles-of-Effective-Web-Design.jpg';
import javascriptCourseImage from '../assets/images.png';
import webDesignCourseImage from '../assets/images.jpg';
...
function HomePage() {
  ...
  const filteredVideos = useMemo(() => {
    let filtered = [...videos]; // Create a copy to avoid mutating state
